    ...
    <div class="detail-wrap">
      <template v-if="type === 'log'">
        ...
        <div class="detail-card">
          ...
          <el-row class="detail-row">
            <el-col :span="12">
              <div class="detail-item"><span class="detail-label">开始时间</span><span class="detail-value">{{ (logForm as any).startTime }}</span></div>
            </el-col>
            <el-col :span="12">
              <div class="detail-item"><span class="detail-label">结束时间</span><span class="detail-value">{{ (logForm as any).endTime }}</span></div>
            </el-col>
          </el-row>
          <el-row class="detail-row">
            <el-col :span="12">
            ...
            <el-col :span="12" v-if="logForm.status == '0' && (logForm as any).startTime && (logForm as any).endTime">
          ...
          <el-row class="detail-row">
            <el-col :span="12">
              <div class="detail-item">
                ...
                <el-tag v-if="(jobForm as any).misfirePolicy == 0" type="info" size="small">默认策略</el-tag>
                <el-tag v-else-if="(jobForm as any).misfirePolicy == 1" type="warning" size="small">立即执行</el-tag>
                <el-tag v-else-if="(jobForm as any).misfirePolicy == 2" type="primary" size="small">执行一次</el-tag>
                <el-tag v-else-if="(jobForm as any).misfirePolicy == 3" type="danger" size="small">放弃执行</el-tag>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="detail-item">
...
const costTime = computed<number>(() => {
  const { startTime, endTime } = logForm.value as any
